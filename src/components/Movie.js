  ...
  return (
    <>
      <div className='max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-blue-800 dark:border-gray-700'>
        ...
        />
        <div className='flex justify-center w-full p-5 h-28'>
        ...
        <>
          <div className='flex justify-center items-center fixed inset-0 z-50 outline-none focus:outline-none'>
            <div className='relative w-auto my-6 mx-auto max-w-3xl'>
              <div className='border-0 rounded-lg  relative flex flex-col w-full dark:bg-gray-800 outline-none focus:outline-none'>
